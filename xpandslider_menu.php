...
*/
    ...
    e107::js(XPN_SLD,'plugins/Camera/scripts/camera.js');
    ...
    */
    ...
    if($slides = $sql->retrieve(DB_SLIDER, '*', 'xpand_slider_class IN ('.USERCLASS_LIST.') ORDER BY xpand_slider_order ASC', true)){
        ...
        foreach($slides as $key => $value){
            ...
            /*
            $res .= '
                <div class="slide" data-slide="'.$value['xpand_slider_id'].'" data-src="'.e_PLUGIN_ABS.XPN_SLD_DIR.XPN_SLD_ELFINDER.$imgs[1].'" data-thumb="'.e_PLUGIN_ABS.XPN_SLD_DIR.XPN_SLD_IMG_DIR.$imgs[0].'">
                    <div class="camera_caption">'.$value['xpand_slider_title'].'</div>
                        <div class="fadeIn camera_effected">'.$value['xpand_slider_content'].'</div>
                            <img src="'.e_PLUGIN_ABS.XPN_SLD_DIR.XPN_SLD_ELFINDER.$imgs[1].'" data-tmb="'.$imgs[0].'" />
                </div>';
            */
